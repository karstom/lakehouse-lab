...
class TestInitScripts(unittest.TestCase):
    ...
    def test_init_script_exists(self):
        ...
        if self.init_script.exists():
            ...
            self.assertTrue(os.access(self.init_script, os.X_OK), "Script should be executable")
    ...
    def test_start_script_exists(self):
        ...
        if self.start_script.exists():
            ...
            self.assertTrue(os.access(self.start_script, os.X_OK), "Script should be executable")
    ...
    def test_init_script_environment_variables(self):
        ...
        self.assertIn('LAKEHOUSE_ROOT', content, "Script should handle LAKEHOUSE_ROOT variable")
        self.assertIn('${LAKEHOUSE_ROOT', content, "Script should use proper variable expansion")
    ...
    def test_start_script_health_checks(self):
        ...
        self.assertIn('check_service_health', content, "Script should have health check function")
    ...
    def test_init_script_minio_client_installation(self):
        ...
        self.assertIn('install_minio_client', content, "Script should install MinIO client")
        self.assertIn('dl.min.io', content, "Script should download from official MinIO site")
    ...
    def test_start_script_docker_requirements(self):
        ...
        self.assertIn('docker compose', content, "Script should check for Docker Compose")
