...
class TestDockerComposeConfigurations(unittest.TestCase):
    ...
    def test_compose_files_exist(self):
        ...
        for compose_file in self.compose_files:
            ...
            self.assertTrue(
                file_path.exists(),
                f"Compose file {compose_file} should exist"
            )
    ...
    def test_main_compose_structure(self):
        ...
        essential_services = [
            ...
            'jupyter', 'airflow-scheduler', 'airflow-webserver',
            'superset', 'portainer'
        ]
    ...
    def test_iceberg_compose_structure(self):
        ...
        for service in spark_services:
            if service in services:
                ...
                self.assertIn('volumes', service_config, f"{service} should have volumes for Iceberg")
                self.assertIn('environment', service_config, f"{service} should have environment for Iceberg")
    ...
    def test_service_health_checks(self):
        ...
        for service in services_needing_health_checks:
            if service in services:
                service_config = services[service]
                self.assertIn('healthcheck', service_config, f"{service} should have healthcheck")
            ...
            if service in services:
                ...
                if 'depends_on' in service_config:
                    ...
                    for dep in expected_deps:
                        self.assertIn(dep, actual_deps, f"{service} should depend on {dep}")
                    ...
                    if isinstance(port_mapping, str):
                        ...
                        if host_port.isdigit():
                            ...
                            self.assertGreaterEqual(host_port, 1024, 
                                                  f"Port {host_port} should be >= 1024")
                            self.assertLessEqual(host_port, 65535,
                                               f"Port {host_port} should be <= 65535")
    ...
    def test_volume_definitions(self):
        ...
        self.assertIn('volumes', compose_data, "Compose file should have volumes section")
    ...
    def test_network_definitions(self):
        ...
        self.assertIn('networks', compose_data, "Compose file should have networks section")
    ...
    def test_environment_variables(self):
        ...
        if 'postgres' in services:
            ...
            for var in required_postgres_vars:
                self.assertIn(var, postgres_env, f"Postgres should have {var} environment variable")
        ...
        for service in spark_services:
            if service in services:
                ...
                if 'volumes' in service_config:
                    ...
                    self.assertTrue(jar_volume_found, f"{service} should have iceberg-jars volume")
    ...
    def test_service_restart_policies(self):
        ...
        for service in critical_services:
            if service in services:
                service_config = services[service]
                self.assertIn('restart', service_config, f"{service} should have restart policy")
                
                restart_policy = service_config['restart']
                valid_policies = ['no', 'always', 'on-failure', 'unless-stopped']
                self.assertIn(restart_policy, valid_policies, 
