...
| **OQ-17** | Trino group-based access control: which group provider (file, LDAP from Keycloak, custom)? | Phase 1 | A file-based group provider generated from Keycloak by the bootstrap job |
