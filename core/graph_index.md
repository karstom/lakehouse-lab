...
| **Active Regressions** | REG_AIRFLOW_DB_INIT(×7), REG_COMPOSE_INLINE_SHELL(×15), REG_CREDENTIAL_PROPAGATION(×16), REG_GENERATED_CODE_SYNTAX(×7), REG_HOST_IP_DETECTION(×3), REG_ICEBERG_JAR_VERSIONS(×6), REG_INIT_CONTAINER_BOOTSTRAP(×13), REG_JUPYTER_PYSPARK_VERSIONS(×12), REG_SUPERSET_SETUP(×6), REG_UPGRADE_VOLUME_DATA_LOSS(×12), REG_V3_CHROMIUM_LOCALHOST_LOOPBACK, REG_V3_OIDC_ISSUER_DEFAULT_PORT | `regressions.md` |
