...
| **Active Regressions** | REG_AIRFLOW_DB_INIT(×7), REG_COMPOSE_INLINE_SHELL(×15), REG_CREDENTIAL_PROPAGATION(×16), REG_GENERATED_CODE_SYNTAX(×7), REG_HOST_IP_DETECTION(×3), REG_ICEBERG_JAR_VERSIONS(×6), REG_INIT_CONTAINER_BOOTSTRAP(×13), REG_JUPYTER_PYSPARK_VERSIONS(×12), REG_SUPERSET_SETUP(×6), REG_UPGRADE_VOLUME_DATA_LOSS(×12), REG_V3_CHROMIUM_LOCALHOST_LOOPBACK, REG_V3_IMAGES_MATRIX_PROFILE_DROPS_BUILD_CONTEXT, REG_V3_OIDC_ISSUER_DEFAULT_PORT, REG_V3_POSTGRES_HEALTHY_BEFORE_TCP, REG_V3_POSTGRES_RECREATE_BREAKS_DB_CLIENTS_ON_UPGRADE, REG_V3_SEAWEEDFS_BINDS_ONLY_DETECTED_IP, REG_V3_SMOKE_AIRFLOW_SPA_LOGIN, REG_V3_STALE_BIND_MOUNT_CONFIG_ON_UPGRADE, REG_V3_STALE_LOCAL_IMAGES_ON_UPGRADE, REG_V3_TRINO_CATALOG_SESSION_DIES_ON_KEYCLOAK_RESTART, REG_V3_TRINO_CURRENT_USER_IN_AGGREGATE, REG_V3_TRINO_SERVICE_TOKEN_NEEDS_OPENID_SCOPE, REG_V3_WORKSPACE_KERNEL_FIRST_MESSAGE_STALL | `regressions.md` |
| **Decisions** | DEC_INIT_CONTAINER_PYTHON_BASE, DEC_MIGRATE_FROM_BITNAMI_OFFICIAL_APACHE_4B39, DEC_NAMED_EXTERNAL_VOLUMES, DEC_REMOVE_DASHBOARD_FUNCTIONALITY_FOCUS_ON_8492, DEC_REMOVE_ICEBERG_ENABLED_FROM_SOURCE_1F54, DEC_REMOVE_MCP_SERVER_COMPLETELY_FROM_67B4, DEC_REMOVE_OAUTH_AUTHENTICATION_SYSTEM_ENTIRELY_2B27, DEC_REMOVE_ORPHANED_CONTAINERS_DURING_UPGRADES_5BC0, DEC_REMOVE_SUDO_DEPENDENCIES_FROM_ALPINE_6EF3, DEC_REMOVE_UNUSED_CODECOV_INTEGRATION_B8A6, DEC_REPLACE_UNRELIABLE_DOCKER_STARTUP_TEST_AD13, DEC_SWITCH_SPARK_3_5_3_A7AE, DEC_V3_AIRFLOW_UMA_MODEL_IN_BOOTSTRAP, DEC_V3_AI_ASSIST_MCP_GATEWAY, DEC_V3_ANALYST_OWN_SCHEMA_GENERATED_TRINO_RULES, DEC_V3_BATCH_SPARK_CREDENTIAL_NOT_TOKEN, DEC_V3_CATALOG_VENDED_STORAGE_ACCESS, DEC_V3_CI_TOOLING, DEC_V3_DOCKER_PROXY_NAME_ALLOWLIST, DEC_V3_ENGINEER_BUDGET_ON_MEASURED_USE, DEC_V3_EXTERNAL_IDP_GITHUB, DEC_V3_FORWARD_AUTH_OAUTH2_PROXY, DEC_V3_GITHUB_IDP_FIRST_BROKER_FLOW, DEC_V3_IDENTITY_SYNC_SERVICE, DEC_V3_KEYCLOAK_SSO_SUBDOMAINS, DEC_V3_LONG_SPARK_JOBS_VIA_AIRFLOW, DEC_V3_PHASE3_INTEGRATION_WIRING, DEC_V3_SPARK_CONNECT_PER_SESSION_TOKEN, DEC_V3_SPARK_INTERNAL_NETWORK, DEC_V3_STACK_DIRECTION, DEC_V3_SUPERSET_API_BEARER_KEYCLOAK, DEC_V3_SUPERSET_TRINO_IMPERSONATION, DEC_V3_TRACK_USER_PRODUCTION_TABLES, DEC_V3_USER_DAGS_SHARED_VOLUME, DEC_V3_VERSIONS_FILE_PREBUILT_IMAGES, DEC_V3_WORKSPACE_CLEANUP_BY_LABEL, DEC_V3_WORKSPACE_JUPYTERHUB_CODESERVER_DBT, DEC_V3_WORKSPACE_TOKEN_VIA_HUB_AUTH_STATE | `decisions.md` |
| **Watchlists & Open Issues** | ISSUE_HARDCODED_MINIO_CREDS_IN_DAG, ISSUE_WEAK_CREDENTIAL_RNG, WATCH_CI_WORKFLOWS, WATCH_CONFIGURE_SERVICES, WATCH_DUPLICATED_HOST_IP_DETECTION, WATCH_ICEBERG_VERSION_SITES, WATCH_INSTALL_UPGRADE_PATH, WATCH_LEGACY_NAMED_INIT_ENTRYPOINT, WATCH_SPARK_PATCH_SKEW, WATCH_UNPINNED_IMAGES, WATCH_V3_AIRFLOW_ENTRYPOINT_ENV, WATCH_V3_CADDY_UPSTREAM_KEEPALIVE_502, WATCH_V3_SHARED_DEV_HOST_OUTAGE_DURING_PARALLEL_TESTS, WATCH_V3_SPARK_CONNECT_INTERMITTENT_HANG, WATCH_V3_WORKSPACE_IMAGE_TAG_SHARED_ACROSS_PROJECTS | `watchlists.md` |
